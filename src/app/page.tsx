...
export default function Home() {
  ...
  const [suggestedProducts, setSuggestedProducts] = useState(undefined);
  const [trendingProducts, setTrendingProducts] = useState(undefined);
  const [recentProducts, setRecentProducts] = useState(undefined);
  ...
  const fn_categoryClicked = (item: any) => {
    router.push(`/StoreprouctPage?category=${item?.slug}`);
  };
